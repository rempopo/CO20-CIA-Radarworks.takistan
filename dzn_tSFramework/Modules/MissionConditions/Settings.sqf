...
MissionCondition1 = [ "WIN", { !alive Radar && (call fnc_CheckPlayersReturned) }, "Радар уничтожен, вернулись в лагерь" ];
MissionCondition2 = [ "KILLED_WIN", { !alive Radar && call fnc_isAllDead }, "Радар уничтожен, игроки погибли", 30 ];
MissionCondition3 = [ "WIPED", { alive Radar && call fnc_isAllDead }, "Радар не уничтожен, игроки погибли", 30 ];
